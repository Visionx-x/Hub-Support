...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002004181082'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/ProSearchRequestGroup')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002004181082').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/MovieHub_Premium') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
...
PAYPICS = (environ.get('PAYPICS', 'https://envs.sh/rn9.jpg')).split()
